import java.util.*;
import java.io.*;
public class OrderedArrayClient {
    ...
    private static void readFile(String fname, OrderedArrayList newList) throws FileNotFoundException {
